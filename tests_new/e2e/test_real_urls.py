...
class TestRealURLsE2E:
    ...
    async def test_grailed_real_listing(self):
        ...
        async with create_session() as session:
            try:
                ...
                print("✅ Grailed E2E Test Results:")
                print(f"   Item: {item_data.title[:50]}...")
                print(f"   Price: ${item_data.price}")
                print(f"   US Shipping: ${item_data.shipping_us}")
    ...
    async def test_grailed_seller_profile_with_headless(self):
        ...
        async with create_session() as session:
            try:
                ...
                print("✅ Grailed Profile E2E Test Results:")
    ...
    async def test_currency_conversion_real_api(self):
        ...
        async with create_session() as session:
            try:
                ...
                print("✅ Currency E2E Test Results:")
    ...
    async def test_shipping_estimation_patterns(self):
        ...
        for title, expected_category in zip(test_titles, expected_categories, strict=True):
            ...
            print(f"   Expected pattern: {expected_category}")
    ...
    async def test_full_pipeline_ebay_to_rub(self):
        ...
        async with create_session() as session:
            try:
                ...
                final_rub = (price_calc.final_price_usd * exchange_rate.rate).quantize(
                    Decimal("0.01")
                )
                ...
                assert (
                    final_rub > price_calc.final_price_usd
                ), "RUB should be larger number than USD"
    ...
    async def test_grailed_app_link_resolution(self):
        ...
        async with create_session() as session:
            try:
                ...
                print("✅ Shortener Resolution Test:")
