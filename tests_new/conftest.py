...
def sample_seller_data():
    ...
    return {
        "excellent_seller": SellerData(
            num_reviews=250, avg_rating=4.9, trusted_badge=True, last_updated=datetime.now(UTC)
        ),
        "good_seller": SellerData(
            num_reviews=50, avg_rating=4.5, trusted_badge=False, last_updated=datetime.now(UTC)
        ),
        "poor_seller": SellerData(
            num_reviews=5, avg_rating=3.2, trusted_badge=False, last_updated=datetime.now(UTC)
        ),
        "no_data": SellerData(
...
def mock_telegram_bot():
    ...
    return {"bot": bot, "update": update, "context": context}
