...
SELLER_WARNING_LOW_RATING = (
    "Я не рекомендую заказывать у этого продавца из-за большого количества негативных отзывов."
)
SELLER_WARNING_NO_REVIEWS = (
    "Я не рекомендую заказывать у этого продавца, так как у него отсутствуют отзывы."
)
ITEM_WARNING_NO_BUY_NOW = (
    "Я не рекомендую покупать этот товар, потому что у него отсутствует цена выкупа."
)
...
NEGOTIATION_NOTE_LINE = (
    ...
    "а доставка занимает ориентировочно 2–3 недели."
)
