...
ITEM_WARNING_NO_BUY_NOW = (
    "⚠️ Я не рекомендую покупать этот товар, потому что у него отсутствует цена выкупа."
)
...
NEGOTIATION_NOTE_LINE = (
    "ℹ️ Примечание: итоговая сумма — ориентировочная; перед выкупом я всегда веду торг с продавцом. "
