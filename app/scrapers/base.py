...
class BaseScraper:
    ...
    def _log_scraping_error(self, url: str, operation: str, error: Exception) -> None:
        ...
        """
        self.logger.error(f"Failed to scrape {operation} from {self.platform_name} ({url}): {error}")
...
class ScraperRegistry:
    ...
    def get_scraper_for_url(self, url: str) -> Optional[ScraperProtocol]:
    ...
    def get_scraper_by_platform(self, platform: str) -> Optional[ScraperProtocol]:
